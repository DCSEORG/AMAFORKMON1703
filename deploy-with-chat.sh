...
# ================================
# Expense Management System - Full Deployment with Gen AI
# ================================
# This script deploys the complete system including Gen AI features

echo "🚀 Starting Expense Management System Deployment with Gen AI..."
echo ""
...
# Deploy full infrastructure (App Service, SQL Database, Gen AI)
echo "🏗️  Deploying full infrastructure (App Service + SQL + Gen AI)..."
...
# Configure App Service settings (including Gen AI)
...
echo "✓ App Service configured with Gen AI settings"
echo ""
...
# Final summary
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║            🎉 FULL DEPLOYMENT WITH GEN AI COMPLETE! 🎉        ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
echo "📍 Application URL: $APP_URL/Index"
echo "🤖 AI Chat Assistant: $APP_URL/Chat/Chat"
echo ""
...
echo ""
echo "✨ Gen AI Features Enabled:"
echo "   - AI-powered chat assistant with natural language queries"
echo "   - Function calling to interact with your expenses"
echo "   - GPT-4o model for intelligent responses"
echo "   - Azure Cognitive Search integration"
echo ""
...
echo "      - OpenAI__Endpoint: $OPENAI_ENDPOINT"
echo "      - OpenAI__DeploymentName: $OPENAI_MODEL_NAME"
